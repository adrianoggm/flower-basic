...
class ECG5000Migrator:
    ...
    def __init__(self, project_root: Path):
        ...
        self.migration_patterns = {
            # Import statements
            r"from \.utils import load_ecg5000_openml": "from .datasets import load_wesad_dataset",
            r"load_ecg5000_openml": "load_wesad_dataset",
    ...
    def migrate_file(self, file_path: Path) -> Tuple[bool, List[str]]:
        ...
        for pattern, replacement in self.migration_patterns.items():
            ...
            if matches:
                ...
                changes_made.append(
                    f"Replaced '{pattern}' -> '{replacement}' ({len(matches)} occurrences)"
                )
        ...
        if content != original_content:
            ...
            self.migrations_applied.append(
                {"file": file_path, "backup": backup_path, "changes": changes_made}
            )
        ...
        for target_dir in target_dirs:
            ...
            for py_file in dir_path.rglob("*.py"):
                ...
                if (
                    ...
                    or "deprecated" in py_file.name.lower()
                ):
                    continue
